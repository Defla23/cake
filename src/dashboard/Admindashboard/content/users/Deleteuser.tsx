...
type DeleteUserModalProps = {
  userToDelete: TUser | null;
  refetchUsers: () => void;
};

export const DeleteUserModal = ({ userToDelete, refetchUsers }: DeleteUserModalProps) => {
  const [deleteUser, { isLoading }] = adminUsersAPI.useDeleteUserMutation();
  ...
  return (
    <dialog id="delete_modal" className="modal sm:modal-middle">
      <div className="modal-box bg-gray-900 text-white w-full max-w-xs sm:max-w-md mx-auto rounded-lg">
